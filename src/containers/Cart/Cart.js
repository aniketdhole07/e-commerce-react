              ...
              <CSSTransition key={id} classNames="fade" timeout={300}>
                <li className="cart-item">
                  <div className="img-wrapper">
                    <img className="cart-item-img" src={img[0]} alt="product img" />
                  </div>
    ...
    return (
      <>
        ...
        <div className="cart-container">
          ...
          <p>Send this products with Name and Amount to +91 8767383986 (WhatsApp and Call) for Payment and Order Confirmation</p> 
          {selected}
          {cartItems.length > 0 &&
